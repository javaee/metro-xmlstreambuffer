 ...
 *
 * <p>
 * A ImmutableXMLStreamBuffer is an abstract class. It is immutable with 
 * respect to the methods on the class, which are non-modifying in terms
 * of state.
 *
 * <p>
 * A ImmutableXMLStreamBuffer can be processed using specific SAX and StAX-based 
 * processors. Utility methods on ImmutableXMLStreamBuffer are provided for 
 * such functionality that utilize SAX and StAX-based processors.
 * The same instance of a ImmutableXMLStreamBuffer may be processed 
 * multiple times and concurrently by more than one processor.
 *
 * <p>
 * There are two concrete implementations of ImmutableXMLStreamBuffer.
 ...
 * processed as an ImmutableXMLStreamBuffer. The second,
 ...
 * ImmutableXMLStreamBuffer instances may make reference to other buffers. It
 * is the responsibility of the application to manage the relationship between
 * such instances.
 *
 * <p>
 * A ImmutableXMLStreamBuffer can represent a complete XML infoset or a fragment 
 ...
 */
public abstract class ImmutableXMLStreamBuffer {
    /**
    ...
    /**
     * Read the contents of the buffer from a {@link XMLStreamReader}.
     *
     * @return
     * A an instance of a {@link StreamReaderBufferProcessor}. Always non-null.
     */
    public final StreamReaderBufferProcessor readFromXMLStreamReader() throws XMLStreamException {
